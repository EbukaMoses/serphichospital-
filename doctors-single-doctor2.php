          ...
          <div class="col-12">
            ...
            <nav>
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="doctors-modern.php">Doctors</a></li>
        ...
        <div class="row">
              ...
              <div class="widget widget-member">
                <div class="member mb-0">
                  ...
                  <div class="member__info">
                    <h5 class="member__name"><a href="doctors-single-doctor2.php">Ahmed Abdallah</a></h5>
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            ...
            <section class="contact-layout4 bg-overlay bg-overlay-secondary-gradient pb-50 pb-50">
              <div class="bg-img"><img src="assets/images/slide3.jpg" alt="banner"></div>
