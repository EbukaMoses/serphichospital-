    ...
    <section class="slider">
      <div class="slick-carousel m-slides-0"
        ...
        <div class="slide-item align-v-h">
          <div class="bg-img"><img src="assets/images/slide.jpg" alt="slide img"></div>
          <div class="container">
        ...
        <div class="slide-item align-v-h">
          <div class="bg-img"><img src="assets/images/slide6.jpg" alt="slide img"></div>
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                <div class="slide__content">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-5">
            ...
            <div class="video-banner-layout2 bg-overlay">
              <img src="assets/images/slide2.jpg" alt="about" class="w-100">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide2.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
                  <i class="icon-doctor"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide3.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide4.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide5.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide6.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              <div class="feature__img">
                <img src="assets/images/slide7.jpg" alt="service" loading="lazy">
              </div><!-- /.feature__img -->
              <div class="feature__content">
                <div class="feature__icon">
            ...
            <div class="slick-carousel"
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/doc.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Mike Dooley</a></h5>
                  ...
                  <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                    <a href="doctors-single-doctor2.php" class="btn btn__secondary btn__link btn__rounded">
                      <span>Read More</span>
                      <i class="icon-arrow-right"></i>
                    </a>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/doc2.png" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Dermatologists</a></h5>
                  <p class="member__job">Cardiology Specialist</p>
              ...
              <div class="member">
                ...
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Maria Andaloro</a></h5>
              ...
              <div class="member">
                ...
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Dupree Black</a></h5>
              ...
              <div class="member">
                ...
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Markus skar</a></h5>
              ...
              <div class="member">
                ...
                <div class="member__info">
                  <h5 class="member__name"><a href="doctors-single-doctor2.php">Kiano Barker</a></h5>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-2 col-lg-2">
              <img src="assets/images/alert2.png" alt="alert">
            </div><!-- /.col-lg-2 -->
              ...
              <div class="slider-nav mb-60">
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="assets/images/1.png" alt="author thumb">
                ...
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="assets/images/2.png" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
                ...
                <div class="testimonial__meta">
                  <div class="testimonial__thmb">
                    <img src="assets/images/3.png" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            ...
            <div class="slick-carousel clients-light mt-20"
              ...
              <div class="client">
                <img src="assets/images/7.png" alt="client">
                <img src="assets/images/7.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/6.png" alt="client">
                <img src="assets/images/6.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/11.png" alt="client">
                <img src="assets/images/11.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/22.png" alt="client">
                <img src="assets/images/22.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/33.png" alt="client">
                <img src="assets/images/33.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/44.png" alt="client">
                <img src="assets/images/44.png" alt="client">
              </div><!-- /.client -->
              <div class="client">
                <img src="assets/images/55.png" alt="client">
                <img src="assets/images/55.png" alt="client">
              </div><!-- /.client -->
            </div><!-- /.carousel -->
          </div><!-- /.col-lg-5 -->
        ...
        <div class="row">
            ...
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.php">
                  <img src="assets/images/slide.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.php">
                  <img src="assets/images/slide2.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
              <div class="post__body">
                <div class="post__meta-cat">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.php">
                  <img src="assets/images/slide3.jpg" alt="post image" loading="lazy">
                </a>
              </div><!-- /.post__img -->
              <div class="post__body">
                <div class="post__meta-cat">
