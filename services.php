 <?php include("header.php")?>
    ...
    <section class="page-title page-title-layout1 bg-overlay">
      <div class="bg-img"><img src="assets/images/slide.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
            ...
            <div class="slick-carousel"
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/slide.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Mike Dooley</a></h5>
                  ...
                  <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                    <a href="services-single.php" class="btn btn__secondary btn__link btn__rounded">
                      <span>Read More</span>
                      <i class="icon-arrow-right"></i>
                    </a>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/slide2.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Dermatologists</a></h5>
                  <p class="member__job">Cardiology Specialist</p>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/slide3.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Maria Andaloro</a></h5>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/slide4.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Dupree Black</a></h5>
              ...
              <div class="member">
                ...
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Markus skar</a></h5>
              ...
              <div class="member">
                <div class="member__img">
                  <img src="assets/images/slide6.jpg" alt="member img">
                </div><!-- /.member-img -->
                <div class="member__info">
                  <h5 class="member__name"><a href="services-single.php">Kiano Barker</a></h5>
        ...
        <div class="row">
          <div class="col-12">
            <div class="slick-carousel"
              ...
              <a class="popup-gallery-item" href="assets/images/slide.jpg">
                <img src="assets/images/slide.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="assets/images/slide2.jpg">
                <img src="assets/images/slide2.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="assets/images/slide3.jpg">
                <img src="assets/images/slide3.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="assets/images/slide4.jpg">
                <img src="assets/images/slide4.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="assets/images/slide2.jpg">
                <img src="assets/images/slide2.jpg" alt="gallery img">
              </a>
              <a class="popup-gallery-item" href="assets/images/slide6.jpg">
